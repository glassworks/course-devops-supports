...
Connectez-vous au serveur GIT, créez votre premier projet, et envoyer votre projet DevOps sur le serveur GIT.

[Suivez ce guide de création et synchronisation d'un projet GIT](https://docs.glassworks.tech/api/mise-en-production/005-git)
